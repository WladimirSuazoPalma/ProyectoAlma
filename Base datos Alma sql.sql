...
BEGIN
    ...
    WHERE
        -- LÓGICA DE FILTRADO BASADA EN EL ROL (Sin usar alias)
        (
            -- CONDICIÓN 1: Si el usuario es Administrador (Rol ID = 1), ve todas las citas.
            @RolID = @AdminRolID 
            OR 
            -- CONDICIÓN 2: Si es Profesional, solo ve sus citas.
            CIT_CITA.CIT_USU_ID_PROFESIONAL = @UsuarioID
        )
        -- Filtra solo las citas que están activas y pendientes
